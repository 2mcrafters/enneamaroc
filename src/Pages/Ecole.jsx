  ...
  const features = [
    {
      ...
      description: "Apprendre en vivant l’Ennéagramme dans sa profondeur.",
    },
    {
      icon: "fa-hand-holding-heart",
      title: "Mise en pratique",
      description:
        "Chaque concept est relié à des situations réelles (personnelle, professionnelle, sociale).",
    },
    {
      icon: "fa-sliders-h",
      title: "Adaptation",
      description:
        "Outils et méthodes pensés pour étudiants, cadres, coachs, thérapeutes, éducateurs, etc.",
    },
    {
      icon: "fa-user-check",
      title: "Accompagnement",
      description:
        "Chaque apprenant est suivi dans son cheminement, avec bienveillance et rigueur.",
    },
  ];
        ...
        >
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              >
                Équipe • Pédagogie • Vision • Mission • Valeurs • Approche
              </h1>
              <p
                style={{
                  fontSize: 20,
              ...
              >
                ...
                praticiens de terrain pour une transmission vivante, rigoureuse
                et humaine de l’Ennéagramme.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <Link
                  to="/contact"
                  style={{
                    ...btn("rgba(255,255,255,0.2)", C.white),
                    fontSize: 16,
                    padding: "14px 28px",
                    fontWeight: 600,
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              >
                L’École EnnéaMaroc réunit une équipe pluridisciplinaire composée
                de formateurs certifiés, de chercheurs universitaires, de coachs
                professionnels et de praticiens de terrain. Chacun apporte sa
                singularité, son expertise et son expérience humaine, afin de
                créer une dynamique d’apprentissage vivante et riche.
              </p>
              <p
                style={{
                  fontSize: 17,
              ...
              >
                Notre force : l’union de compétences locales et internationales
                pour garantir une pédagogie adaptée au contexte marocain et
                ouverte sur le monde.
              </p>
              <Link
                to="/#pourquoi-enneamaroc"
                style={{
                  ...btn(C.blue, C.white),
                  fontSize: 16,
                  padding: "12px 24px",
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 14, color: "#6c757d", marginBottom: 5 }}
                  >
                    Notre approche
                  </div>
        ...
        <div className="container">
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              ...
              <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.9)', lineHeight: 1.7 }}>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: 30 }}>
                  <div style={{
                    ...
                    <i className="fas fa-bullseye" style={{ fontSize: 24, color: C.blue }} />
                  </div>
                  <h3 style={{ fontSize: 22, fontWeight: 700, color: C.black, marginBottom: 15 }}>
                    Notre Vocation
                  </h3>
                  <p style={{ fontSize: 16, color: '#6c757d', lineHeight: 1.7, marginBottom: 25 }}>
                    En tant que première école de l'Ennéagramme au Maroc, nous avons pour vocation de :
                  </p>
                </div>
                  ...
                  {[
                    ...
                    <div key={idx} style={{ display: 'flex', gap: 12, alignItems: 'start' }}>
                      <div style={{
                        ...
                        <i className="fas fa-check" style={{ fontSize: 12, color: C.white }} />
                      </div>
                      <p style={{ fontSize: 15, color: '#6c757d', margin: 0, lineHeight: 1.7 }}>
                        {text}
                      </p>
                    </div>
                  ))}
              ...
              <div style={{
                ...
                <div style={{ marginBottom: 30 }}>
                  <div style={{
                    ...
                    <i className="fas fa-gem" style={{ fontSize: 24, color: C.red }} />
                  </div>
                  <h3 style={{ fontSize: 22, fontWeight: 700, color: C.black, marginBottom: 15 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                  {[
                    { title: 'Ouverture', text: 'à la fois enracinée dans le contexte marocain et connectée aux courants internationaux.' },
                    { title: 'Diversité', text: 'nos formations s\'adressent aussi bien aux étudiants, professionnels, coachs, enseignants, managers, psychologues, qu\'à toute personne en quête de sens et de transformation.' },
                    { title: 'Ancrage', text: 'nous valorisons la richesse culturelle et humaine du Maroc, en l\'intégrant dans l\'enseignement de l\'Ennéagramme.' },
                    { title: 'Engagement', text: 'contribuer à l\'émergence d\'une nouvelle génération de leaders humains, responsables et alignés.' }
                  ].map((item, idx) => (
                    <div key={idx} style={{ display: 'flex', gap: 12, alignItems: 'start' }}>
                      <div style={{
                        width: 24,
                        ...
                        <i className="fas fa-star" style={{ fontSize: 11, color: C.white }} />
                      </div>
                      <p style={{ fontSize: 15, color: '#6c757d', margin: 0, lineHeight: 1.7 }}>
                        <strong style={{ color: C.black }}>{item.title}</strong> : {item.text}
                      </p>
                    </div>
                  ))}
                </div>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              >
                Découvrez nos parcours certifiants et entrez dans une dynamique
