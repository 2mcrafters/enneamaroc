...
const Approfondir = () => {
  ...
  const PROGRAM_SUBTITLE =
    "Approfondir : Voyage intérieur – Mécanismes, Ombres et Potentiels";
  ...
  const modules = [
    {
      ...
      description:
        "Ce module est l'expérience initiale du modèle de l'ennéagramme. Elle s'appuie sur des activités dans les 3 centres (mental, émotionnel, instinctif).",
      details:
        "Chacun repère à partir de vidéos, d'exercices variés et d'auto-observation, sa base de départ parmi les 9 possibles. Les résultats au questionnaire scientifiquement validé HPEI sont donnés en cours de séminaire, ainsi que la brochure « L'ennéagramme évolutif : les 9 bases ».",
      icon: "fa-compass",
    },
    {
      id: 2,
              ...
              <div className="row g-4">
                ...
                <div className="col-md-6">
                  ...
                  >
                    ...
                    <ul
                      ...
                      style={{ paddingLeft: 0, listStyle: "none" }}
                    >
                      {["La formation", "Livre « 9 bases »", "Pauses café"].map(
                        (t, i) => (
                          <li
                            key={i}
                            style={{
                ...
                <div className="col-md-6">
                  ...
                  >
                    ...
                    >
                      <h3 className="mb-1" style={{ fontWeight: 800 }}>
                        Formateurs assujettis & Entreprises
                      </h3>
                      <span className="pill" style={pill(C.blue, C.white)}>
                        HTVA
                      </span>
