          ...
          <div className="row align-items-center">
            <div className="col-lg-10 mx-auto text-center">
              ...
              <p className="mb-4" style={{ color: C.white }}>
                Un parcours avancé pour transmettre l’ennéagramme avec justesse,
                éthique et impact.
              </p>
          ...
          <div className="row">
            <div className="col-lg-9 mx-auto text-center">
              ...
              <p className="mt-3" style={{ color: C.black }}>
                ...
                progression de l’animation des panels jusqu’à la certification,
                en passant par l’entretien typologique, la supervision et un
                projet soutenu.
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                >
                  ...
                  <p style={{ color: C.black, marginBottom: 0 }}>
                    <i className="fas fa-clock" style={{ marginRight: 6 }} /> 9H
                    – 17H
                  </p>
                </div>
              </div>
                ...
                <div className="row align-items-center g-3">
                  <div className="col-12">
                    <div style={{ marginLeft: 14 }}>
                      ...
                      >
                        Prêt à transmettre avec maîtrise ?
                      </h2>
                      <p className="mb-0" style={{ color: C.black }}>
                        Un parcours complet de 6 modules pour allier
                        compréhension profonde et transmission efficace de
                        l’ennéagramme.
                      </p>
                    </div>
                  </div>
