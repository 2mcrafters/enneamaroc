    ...
    <section className="service-section style-3 bg-dark">
      <div className="container space">
        <div className="title-area three white text-center">
          <div className="sub-title" style={{ color: "var(--theme-color3)" }}>
            <span>
          ...
          <h2 className="sec-title">
            Des <b>solutions</b> sur-mesure
            <br /> pour votre évolution
          </h2>
          <p className="sec-text">
            Coaching & Ennéagramme pour clarifier vos objectifs, renforcer vos
            relations et développer un leadership authentique.
          </p>
        </div>
